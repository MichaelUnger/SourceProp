...
evolutions=("Mm40" "Mm35" "Mm30" "Mm25" "Mm20" "Mm15" "Mm10" "Mm05" "M00" "M05" "M10" "M15" "M20" "M25" "M30" "M35" "M40" "M45" "M50" "SFR2")
...
do
  export EVO=$evolution
  export PRODNAME=Mix2_${EVO}_${IRB}
