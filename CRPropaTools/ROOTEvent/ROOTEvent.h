...
namespace crpropa {
  ...
  public:
    ...
    /// mass number
    unsigned short GetMass() const { return (fId/10)%1000; }
    /// charge
    unsigned short GetCharge() const { return (fId/10000)%1000; }
    /// energy [EeV]
  ...
  public:
    ...
    /// mass number
    unsigned short GetMass() const { return (fId0/10)%1000; }
    /// charge
    unsigned short GetCharge() const { return (fId0/10000)%1000; }
    /// energy [EeV]
